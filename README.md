...
![graph LR Zasilacz --- |Zwora| Zasilacz Zasilacz --> |Zasilanie +5Vsb| Mikrokontroler Zasilacz --> |Zasilanie +5V| Złącza[Złącza MR60] subgraph Obudowa Mikrokontroler --> |DATA| Złącza[Złącza MR60] end Złącza[Złącza MR60] --> LED[Pasek LED]](https://svgshare.com/i/Sjq.svg)
